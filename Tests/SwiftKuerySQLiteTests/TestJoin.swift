                                                ...
                                                executeQuery(query: i3, connection: connection) { result, rows in
                                                    ...
                                                    executeQuery(query: s1, connection: connection) { result, rows in
                                                        ...
                                                        executeQuery(query: s2, connection: connection) { result, rows in
                                                            ...
                                                            XCTAssertEqual(rows![0][0]! as! String, "apricot", "Wrong value in row 0 column 0: \(rows![0][1]) instead of 'apricot'")
                                                            XCTAssertEqual(rows![1][0]! as! String, "apple", "Wrong value in row 0 column 0: \(rows![1][1]) instead of 'apple'")
